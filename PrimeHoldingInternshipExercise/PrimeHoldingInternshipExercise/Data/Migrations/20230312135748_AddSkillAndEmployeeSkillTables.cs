    ...
    public partial class AddSkillAndEmployeeSkillTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ability to write computer programs", "Programming" },
                    { 2, "Ability to develop web applications", "Web Development" },
                    { 3, "Ability to manage and maintain databases", "Database Management" }
                });
